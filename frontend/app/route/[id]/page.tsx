    ...
    try {
      ...
      const sampleRoutes = [
        ...
        },
        {
          ...
          fare: { min: 15, max: 25, studentDiscount: true },
          timings: {
        ...
        {
          _id: "route3",
          from: { name: "City Center" },
          to: { name: "IT Park" },
          transportType: "E-rickshaw",
          fare: { min: 40, max: 60, studentDiscount: false },
          timings: {
      ...
      const foundRoute = sampleRoutes.find(r => r._id === params.id)
      if (foundRoute) {
        setRoute(foundRoute)
      } else {
